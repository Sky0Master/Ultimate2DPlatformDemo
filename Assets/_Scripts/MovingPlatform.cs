...
namespace Cainos.PixelArtPlatformer_VillageProps
{
    ...
    public class MovingPlatform : MonoBehaviour
    {
        ...
        public List<Transform> GetOnPlatformObjects()
        {
            return onPlatformObjects;
        }
        ...
        {
            if (collision.attachedRigidbody && collision.gameObject.tag == "Player") // && collision.attachedRigidbody.bodyType == RigidbodyType2D.Dynamic)
            {
