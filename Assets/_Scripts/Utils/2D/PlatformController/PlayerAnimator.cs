...
namespace TarodevController {
    ...
    public class PlayerAnimator : MonoBehaviour {
        ...
        void Update() {
            ...
            _anim.SetFloat("HorizontalAxis",_player.Input.X);
            _anim.SetFloat("VerticalAxis",_player.Input.Y);
            if(_player.JumpingThisFrame)
        ...
        private static readonly int GroundedKey = Animator.StringToHash("onGround");
